...
I am an incoming Ph.D. student in Statistics at UC Berkeley starting in Fall 2026. My current interests include: interpretable machine learning, uncertainty quantification (e.g., conformal prediction and probabilistic forecasting), and statistical inference (selective/post-selection inference).
...
I am passionate about supporting junior students and underrepresented groups in STEM, particularly women in statistics/math/computer science. If I can be any of help to you, please reach out to me at prithika_roy@berkeley.edu to schedule some time to chat about research, grad school applications, careers, etc.
